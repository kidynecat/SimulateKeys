...
namespace simulatekeys
{
    public partial class Form1 : Form
    {
        ...
        private void b2_SetKeyEventHandle(object arg1, SetKeyEventArgs arg2)
        {
            ...
            AddHandleKey(nowHotKeyCode, arg2.keycode, arg2.keyname,"0","0");

        }

        private void AddHandleKey(string HotKeyCode,string HandleKeyCode ,string HandleKeyName,string StartInterval,string EndInterval)
            
        {
            ...
            lb.Location = new Point(50, 3);

            TextBox tb1 = new TextBox();
            tb1.Width = 45;
            tb1.Height = 30;
            tb1.KeyPress += textNumberKeyPress;
            tb1.Text = StartInterval;
            ...
            tb2.Text = EndInterval;
            tb2.Font = new Font("宋体", 12f);
            tb2.Location = new Point(150, 0);
        ...
        private void startIChange(object sender, EventArgs e)
        {
            ...
            {
                sysParam.hotkeyDatas[hotkeycode].keyHandles[handlekeycode].startInterval = v;
            }
            else
            {
                sysParam.hotkeyDatas[hotkeycode].keyHandles[handlekeycode].startInterval = 0;
        ...
        private void endIChange(object sender, EventArgs e)
        {
            ...
            if (int.TryParse((sender as TextBox).Text, out v))
            {
                sysParam.hotkeyDatas[hotkeycode].keyHandles[handlekeycode].endInterval = v;
            }
            else
            {
                sysParam.hotkeyDatas[hotkeycode].keyHandles[handlekeycode].endInterval = 0;
               (sender as TextBox).Text = "0";
            }
        }
        ...
        private void reflash()
        {
            ...
            foreach(var hkd in sysParam.hotkeyDatas.Values )
            {
                ...
                {
                    AddHandleKey(hkd.hotKeyCode, hk.hitKeyCode, hk.hitKeyName,hk.startInterval.ToString(),hk.endInterval.ToString());
                }
            }
